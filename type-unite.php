						...
						<div class="pb-20">
							...
							>
								...
								<?php foreach($unite as $unite):?>
									<tr>
										<td class="table-plus"><?= $unite['id'] ?></td>
										<td><?= $unite['nom'] ?></td>
										...
										<div class="dropdown">
											...
											>
												...
												>
												<a class="dropdown-item" href="modifier-unite.php?id=<?=$unite['id']?>"								><i class="dw dw-edit2"></i> Edit</a
												>
												<a class="dropdown-item" href="supprimer-unite.php?id=<?=$unite['id']?>"
