<?php
	...
	$stmt = $pdo->prepare('SELECT qtevendu, vente_id, SUM(montantvente) AS prix FROM vente GROUP BY datevente');
	$stmt->execute();
	$tovente = $stmt->fetchAll(PDO::FETCH_ASSOC);
	...
	<?php include('entete.php'); ?>
		...
		<div class="card-box pb-10">
					...
					<table class="data-table table nowrap">
						...
						<tbody>
							<?php foreach($tovente as $tovente): ?>
							<tr>
								<td class="table-plus">
									
										<div class="txt">
											<div class="weight-600"><?= $tovente['qtevendu'] ?></div>
										</div>
								</td>
								<td><?= $tovente['prix'] ?></td>
								<td><?= $tovente['vente_id'] ?></td>
								<td>
									<span
