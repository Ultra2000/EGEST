<?php 
	...
	if (!empty($_POST)) {
		...
		$etat = 0;
		$stmt = $pdo->prepare('INSERT INTO vente VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
		$stmt->execute([$id,  $articleid, $unite, $quantite, $datevente, $refvente, $client, $prixvente, $prixttc, $etat]);
		// Output message
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">#Vendre</h4>
								<p class="mb-30"></p>
							</div>
							
						</div>
						<form action="vendre.php?id=<?= $articles['id'] ?>" method="POST" name="myform">
                            ...
                            <div class="row">
								...
								<div class="col-md-3 col-sm-12">
									<div class="form-group">
										...
										<input type="number"  value="<?= $articles['prixvente'] ?>" name="prixvente" class="form-control" />
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-12">
									<div class="form-group">
										...
										<input type="date" required name="datevente" class="form-control" />
									</div>
								</div>
								...
								<div class="col-md-3 col-sm-12">
									<div class="form-group">
										...
										<input type="text" placeholder="VTE1" name="refvente" required class="form-control" />
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-12">
									<div class="form-group">
											...
											<option value = "<?= $clients['id'] ?>"> <?= $clients['nomprenomscl'] ?></option>
											<?php endforeach; ?>
											</select>
							...
							<input type="submit" class="btn btn-primary" data-bgcolor="#3b5998"
										data-color="#ffffff" value="Vendre">
				...
				<div class="footer-wrap pd-20 mb-20 card-box">
					GESTION DE STOCK BY <strong>FRECORP</strong>
				</div>
			</div>
		</div>
